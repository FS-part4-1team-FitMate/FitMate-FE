  ...
  if (size === "lg") {
    return (
      <div className="flex gap-[0.2rem] pc:gap-[0.4rem]">
        ...
        />
        <div className="flex gap-[0.2rem] pc:gap-[0.4rem]">
          <p className="text-sm font-medium pc:text-lg">{rating?.toFixed(1) || "0.0"}</p>
          <p className={"text-gray-300 text-sm font-medium pc:text-lg"}>({reviewCount || 0})</p>
        </div>
      </div>
    );
  }
  ...
  if (size === "sm") {
    return (
      <div className="flex gap-[0.2rem]">
        ...
        <div className="flex gap-[0.2rem]">
          <p className="text-sm font-medium">{rating?.toFixed(1) || "0.0"}</p>
          <p className={"text-gray-300 text-sm font-medium"}>({reviewCount || 0})</p>
        </div>
      </div>
    );
  }
