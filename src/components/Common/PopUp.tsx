    ...
    >
      <div className="relative bg-white text-slate-900 w-[384px] max-w-full p-[16px] rounded-2xl shadow-lg">
        ...
        <div className="flex justify-end gap-[8px] mt-[16px]">
          {!onlyCancel && (
            <button
              className="px-[24px] py-[8px] text-lg rounded-xl bg-blue-600 text-white"
              onClick={() => {
          ...
          <button
            className="px-[24px] py-[8px] text-lg rounded-xl bg-white text-slate-900 border border-solid border-gray-900"
            onClick={() => {
